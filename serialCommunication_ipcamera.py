...
# made to connect with an IP Camera
...
while 1:
        ...
        if((distance <= 50) and (distance >= 0)):
                print 'Sending email with picture...'
                # send email notification
                subprocess.call("send_gmail.py", shell=True)
                print 'Picture sent to Gmail!'
                print arduinoData
                objDetected = True
                ser.write('d')
                ...
                scriptOutput = subprocess.check_output([sys.executable, "checkForFace_ipcamera.py", "34"])
                ...
                if(scriptOutput != ''):
                        ...
                        ser.write('n')
                #resume = raw_input("Would you like to resume program: ")
        ...
        if(resume == 'y'):
                ...
                objDetected = False;
                time.sleep(2)
                arduinoData = ser.readline().encode('utf-8')
        '''       
        #print (distance)
